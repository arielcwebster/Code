	...
	public void life (){
		...
		for (int one = 0; one <= 24; one ++){ 
			for(int each = 0; each <= 24; each++){ 
				...
				if (one == 0 && each == 0){ // for the upper left most cell
				...
				if (one == 0 && each == 24){ // for the upper right most cell
				...
				if (one == 24 && each == 0){ // for the lower left most cell
				...
				if (one == 24 && each == 24){ // for the lower right most cell
				...
				if (one == 24){//x=25, right most column
				...
				if (each == 24){ // y=25, bottom row - fixed
